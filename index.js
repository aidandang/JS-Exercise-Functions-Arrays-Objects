...
function getName(myPersonalObject) {
  let myName = "Hello, my name is " + myPersonalObject.name;
...
function getModelYears(inventory) {
  ...
  // This is what I think the output should be, array of model years without duplicating.
  /*
  ...
  */
  ...
  // This is solution just to match with the answer.
  let carYears = [];
  for (i = 0; i < inventory.length; i++) {
    carYears.push(inventory[i].car_year);
  }
